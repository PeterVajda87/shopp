...
BEGIN
    ...
    -- Insert into image gallery using the obtained product_id
    INSERT INTO product_image (path, main_image, image_order, product_id) VALUES ('product/prd.webp', True, 0, v_product_id);
